...
function connectionsShowAffiliatePage() {
	...
	if ( ! current_user_can( 'connections_edit_categories' ) ) {
		...
		if ( $action === "edit_{$taxonomy}" ) {
			...
			<div class="wrap">
				<div class="form-wrap" style="width:600px; margin: 0 auto;">
					<h1><a name="new"></a><?php _e( 'Edit Affiliate', 'connections-affiliations' ); ?></h1>
					...
					<div class="form-field form-required term-name-wrap">
						<label for="term_name"><?php _e( 'Name', 'connections-affiliations' ) ?></label>
						...
						<p><?php _e( 'The name is how it appears on your site.', 'connections-affiliations' ); ?></p>
					</div>

					<div class="form-field term-slug-wrap">
						<label for="term_slug"><?php _e( 'Slug', 'connections-affiliations' ); ?> </label>
					...
					$cancelURL = add_query_arg( 'page', 'connections-affiliations', self_admin_url( 'admin.php' ) );
					?>

					<!--<input type="hidden" name="cn-action" value="update_category"/>-->

					<p class="submit">
						<a class="button button-warning" href="<?php echo esc_url( $cancelURL ); ?>"><?php _e( 'Cancel', 'connections-affiliations' ); ?></a>
						<input type="submit" name="update" id="update" class="button button-primary" value="<?php _e( 'Update Affiliate', 'connections-affiliations' ); ?>"/>
					</p>
		...
		<?php
			...
			<div class="wrap nosubsub">
				...
				<h1>Connections : <?php _e( 'Affiliations', 'connections-affiliations' ); ?></h1>

				<form class="search-form" action="" method="get">

					<input type="hidden" name="page" value="<?php echo esc_attr( $_REQUEST['page'] ); ?>"/>
					<?php $table->search_box( __( 'Search Affiliations', 'connections-affiliations' ), $taxonomy ); ?>
				...
				<div id="col-container">
									...
									$(document).ready(function () {
										$('#doaction, #doaction2').click(function () {
											if ($('select[name^="action"]').val() == 'delete') {
												var m = 'You are about to delete the selected affiliation(s).\n  \'Cancel\' to stop, \'OK\' to delete.';
					...
					<div id="col-left">
						<div class="col-wrap">
							...
							<div class="form-wrap">
								<h3><?php _e( 'Add New Affiliate', 'connections-affiliations' ); ?></h3>
								...
								submit_button( __( 'Add New Affiliate', 'connections-affiliations' ), 'primary', 'add' );
